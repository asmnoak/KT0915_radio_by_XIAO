 ...
 *   #### adapt to Seeduino XIAO by asmnoak 2022.9.1
 * 
 ...
 * 
 * @original author Ricardo Lima Caratti (pu2clr@gmail.com)
 * @modified by asmnoak 2022.9.1
...
#define RESET_PIN -1 // 12            // You can use the Arduino RST pin. In this case, set it to -1
...
// Buttons controllers
#define BAND_MODE_SWITCH_UP 3     // Switch to: FM -> MW(AM) -> SW1(AM) -> SW2(AM) etc
#define BAND_MODE_SWITCH_DOWN 2   //
#define VOL_UP    7               // Volume Up/Down
#define VOL_DOWN  6               // Volume 
#define TEST_BUTTON1   9          // freq Up/Down
#define TEST_BUTTON2 8            // freq 
...
char am_bw[] = {'4', '4', '4','6','X'};   //#### 2 -> 4

akc_band band[] = {
    {MODE_FM, 76000, 108000, 80400, 100}, //####
    {MODE_AM, 520, 1710, 747, 9},  ///####
    ...
    {MODE_AM, 13500, 14300, 13600, 10},
    {MODE_AM, 15000, 15900, 15300, 10},
    {MODE_AM, 17400, 17900, 17600, 10},  
    {MODE_AM, 21400, 21900, 21525, 10},
    {MODE_AM, 27000, 28000, 27500, 10}};
...
uint32_t currentFM = 80400; ///####
uint32_t currentAM = 747;  ///####
...
void setup()
{
  ...
  //radio.setTuneDialModeOn(76000, 108000);  //####
  showStatus();
}
